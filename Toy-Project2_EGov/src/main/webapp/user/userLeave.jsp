...
<link rel="stylesheet" type="text/css" href="<c:url value='/css/user/userLeave.css'/>" />
<script src="<c:url value='/js/user/userLeave.js'/>"></script>
<title>회원 탈퇴</title>
</head>
<body>
	...
	<div class="vertical-center">
		...
		<div class="form-check form-check-inline">
	  		<input class="form-check-input" type="checkbox" id="inlineCheckbox1" onclick="agreeChecked()">
